...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/gsap.min.js":[function(require,module,exports) {
var define;
    ...
    function Tween(t, e, i, n) {
      ...
      if (a._targets = D.length ? Y(D) : M("GSAP target " + t + " not found. https://greensock.com", !U.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = w, x || b || u(v) || u(y)) {
        if (e = a.vars, (o = a.timeline = new Bt({
          ...
          if (f = D.length, _ = b ? Ra(b) : O, r(b)) for (d in b) {
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/gsap.min.js"], null)
//# sourceMappingURL=/gsap.min.0035ed79.js.map